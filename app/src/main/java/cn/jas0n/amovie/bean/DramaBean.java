...
public class DramaBean implements Serializable {
    ...
    public class Data implements Serializable {
        private List<RecDramaItem> lastUpdate;
        private List<RecDramaItem> recommended;
        private List<RecDramaItem> hot;

        public List<RecDramaItem> getLastUpdate() {
            return lastUpdate;
        }

        public void setLastUpdate(List<RecDramaItem> lastUpdate) {
        ...
        public List<RecDramaItem> getHot() {
            return hot;
        }

        public void setHot(List<RecDramaItem> hot) {
            this.hot = hot;
        }
